...
export class AiLimitError extends Error {
  constructor(message: string, public readonly status = 429, public readonly retryAfter = 60) { super(message); }
}
...
export type AiContext = { ownerId: string; requestId: string; reservationId?: string };
