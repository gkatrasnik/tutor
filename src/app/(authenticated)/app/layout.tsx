      ...
      <header className="sticky top-0 z-30 border-b bg-white/90 backdrop-blur">
        <div className="mx-auto flex h-16 max-w-[90rem] items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <span className="hidden max-w-52 truncate text-sm text-stone-500 sm:inline">{displayName}</span>
            <Avatar className="size-9">
              <AvatarFallback className="bg-emerald-100 text-emerald-800">{initials || "TU"}</AvatarFallback>
            </Avatar>
          </div>
        </div>
      </header>
        ...
        <aside className="sticky top-16 hidden h-[calc(100vh-4rem)] w-60 shrink-0 flex-col border-r bg-white p-4 md:flex">
          ...
          <div className="mt-auto">
            ...
            <form action={signOutAction}>
              <Button type="submit" variant="ghost" className="mt-1 w-full justify-start text-stone-600">
