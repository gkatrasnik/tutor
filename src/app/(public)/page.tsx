    ...
    <main className="min-h-screen overflow-hidden bg-[#fbfcf9]">
      ...
      <section className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 pb-24 pt-16 sm:px-8 lg:grid-cols-[1.08fr_0.92fr] lg:pb-32 lg:pt-24">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-balance max-w-3xl text-5xl font-semibold leading-[1.02] tracking-[-0.045em] text-stone-950 sm:text-6xl lg:text-7xl">
        ...
        <div className="relative z-10 mx-auto w-full max-w-lg lg:mx-0">
          <div className="absolute -inset-8 rounded-[3rem] bg-gradient-to-br from-emerald-200/60 via-amber-100/40 to-transparent blur-2xl" />
          <Card className="relative overflow-hidden border-stone-200/80 bg-white/95 py-0 shadow-[0_24px_80px_-28px_rgba(28,44,36,0.35)]">
      ...
      <footer className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-5 py-8 text-sm text-stone-500 sm:flex-row sm:items-center sm:justify-between sm:px-8">
        <Brand />
